...
data_path = 'data/N44/'
data_filename = 'N44_LL1'
unc_filename = 'N44_LL1_unc'
# back_filename = 'm82_off_LL1'
out_path = data_path+'convolved/'
rpj_path = data_path+'reprojection/'

ph_path = '/Users/dhu/data/photometry/LMC/'
ph_filename = 'sage_mips24_montage32_rot_22jun06.cal'
# ph_filename = 'NGC5236_Spitzer_24'
# ph_filename = 'ngc3034_mips24_image_v5-0'
# ph_filename = 'irac_c3'
...
## mips024 LMC mosaic background [xmin, xmax, ymin, ymax]
c = [1998, 2028, 758, 788]
...
photometry, ft = rpj(data_path+out_ph, rpj_path+out_ph, hdr)
# PHerr, ft = rpj(data_path+out_ph+'_unc', rpj_path+out_ph, hdr)
# print("PHerr shape = ", PHerr.shape)

# photometry = photometry*(1*u.Jy/u.pixel).to(u.MJy/u.sr, equivalencies=u.dimensionless_angles())
...
calibview(Fnu_ph, Fnu_filt, yerr=Unc_filt, xerr=Unc_ph, \
	threshold=2., \
	xlabel="MIPS1 (MJy/sr)", ylabel="IRS LL1 (MJy/sr)", \
