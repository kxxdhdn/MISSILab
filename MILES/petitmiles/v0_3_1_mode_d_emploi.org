...
python /your_testing_place/petitmiles/python/input_genpar.py
cd /your_testing_place/petitmiles/programs
make
./genpar
python /your_testing_place/petitmiles/python/show_genpar.py # optional
./simulate_MIR
## Line 40-42 & 65 may can be modified according to simulate_MIR.90
python /your_testing_place/petitmiles/python/show_galspec.py # optional
#+END_SRC
* Fitting
#+BEGIN_SRC bash
python /your_testing_place/petitmiles/python/input_fitpar_chi2.py
./fitpar_chi2
...
python /your_testing_place/petitmiles/python/show_fitpar.py # optional
## Open show_corr.py and comment line 23 (mod = 'HB')
python /your_testing_place/petitmiles/python/show_corr.py # optional

## Open input_fitpar_HB.py and modify line 65 (Nmcmc)
python /your_testing_place/petitmiles/python/input_fitpar_HB.py
./fitpar_HB
