...
END MODULE fitMIR_nhB_external
...
PROGRAM fitMIR_nhB
  ...
  USE fitMIR_nhB_external, ONLY: Nx, Ny, NwOBS, wOBS, nuOBS, xOBS, yOBS, &
  ...
  CHARACTER(*), PARAMETER :: filOUT = dirOUT//'test_fitnhB'//h5ext
  CHARACTER(*), PARAMETER :: filMCMC = dirOUT//'parlog_fitnhB'//h5ext
...
! print*, "coucou3"
  ...
  print*, 'nhB fit M83 IRS obs [done]'//NEW_LINE('')
  ...
  print*, 'fitnhB analysis [done]'//NEW_LINE('')
