...
for i in range(Ncorr):
    ...
    for pz in range(N1):
        ...
        p1 = plotool()
        p1.figure((10,12), nrows=3, ncols=N1)
        p1.set_fig(left=.1, bottom=.1, right=.95, top=.95,
                   wspace=1, hspace=.5)
        ...
        for py in range(int(Nq/N1)):
            ...
            for px in range(3):
                ...
                p1.plot(Rsim[x,iq,:], func(Rsim[x,iq,:], *popt),
                ...
                if px==0:
                    ...
                    if h5_out.exists():
                        ...
                        p1.plot(Rfit_chi2[x,iq,:], func(Rfit_chi2[x,iq,:], *popt),
                ...
                ## BB
                    ...
                    if h5_out.exists():
                        ...
                        p1.plot(Rfit_bb[x,iq,:], func(Rfit_bb[x,iq,:], *popt),
                                c='y', label='a(fit)={:.2}'.format(popt[0]))
                ## HB
                elif px==2:
                    ...
                    if h5_out.exists():
                        ...
                        p1.plot(Rfit_hb[x,iq,:], func(Rfit_hb[x,iq,:], *popt),
                                c='y', label='a(fit)={:.2}'.format(popt[0]))
