...
###      Comparing different photometries
...
for j in trange(Nmc+1,
    ...
    if j==0:
        ...
        concatenate(files, path_out+src+'_IRS_'+str(j), sort_wave=False)
...
iw_sl_end = closest(x, 14.28)
print('coucou iw_sl_end = ', str(iw_sl_end))
# for i in range(5):
#     x[100+i*2] = x[100+i*2+1]
#     y[100+i*2] = y[100+i*2+1]
#     dy[100+i*2] = 0
# for i in range(3):
#     for j in range(4):
#         x[208+i*4+j+1] = x[208+i*4]
#         y[208+i*4+j+1] = y[208+i*4]
#         dy[208+i*4+j+1] = 0

yy = y[:,ry,rx].copy()
yy[:iw_sl_end] = yy[:iw_sl_end]*calib_fac


fig2, ax2 = plt.subplots(figsize=(8,5))
ax2.errorbar(x[:], y[:,ry,rx],
             c='b', ls='dotted', label='no calib')
ax2.errorbar(x[:], yy, dy[:,ry,rx],
