...
##        Combine slits
##---------------------------
# refheader = fixwcs(fits_irc[0]).header
...
ax2.errorbar(x[2:], (y[2:,ry,rx]+calib_off)*calib_fac, dy[2:,ry,rx], \
