...
parobs = [
    ...
    ['A1_7','1120103.1','NG','F_N002','Nh',28,7,3,'r','*'], # A1-7
    ['B1_7','1120103.2','NG','F_N002','Nh',28,7,3,'orange','*'], # B1-7
    ['C1_7','5200015.1','NG','F_N002','Nh',28,7,3,'y','*'], # C1-7
    ['D1_4','5200015.2','NG','F_N002','Nh',24,4,3,'g','d'], # D1-4
