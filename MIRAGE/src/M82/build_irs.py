...
for i in range(Nphot):
    ...
    if pre_calib2=='y':
        ...
        # gen_unc2 = input("Create SINGS IRAC4/MIPS1 uncertainty map (y/n)? ")
        # if gen_unc2=='y':
        #     ds_wgt = read_fits(wgt_phot2)
        #     if phot[i]== 'IRAC4':
        #         bg = read_fits(raw_phot2).data[502:542,1067:1107]
        #         bg_wgt = ds_wgt.data[502:542,1067:1107]
        #     elif phot[i]=='MIPS1':
        #         bg = read_fits(raw_phot2).data[450:490,1606:1646]
        #         bg_wgt = ds_wgt.data[450:490,1606:1646]
        #     wfac = .1
        ...
        #              tmpdir=path_tmp, verbose=verbose)
        # for j in trange(Nmc+1,# leave=False,
        #                 desc=phot[i]+': SINGS reproj + conv [MC]'):
        #     if j==0:
        #         ## Reproject phot
    ...
    if int_calib=='y':
        ...
        if do_correct=='y':
            ...
            if do_indiv=='y':
                ...
                ## Supplementary mask
                # mask2D_s = (data_spec/data_phot2>1.) # Define supp creterion
